...
const ResetPasswordFields = () => {
  ...
  return (
    <div className="flex-col self-stretch ">
      <div className="self-stretch h-16 p-2.5 bg-gray-200 mb-2 dark:bg-gray-900 rounded-[5px] shadow border border-none flex-col justify-start items-start gap-[5px] flex">
