...
const SelectionSearchField = ({ selectionFunc, onAdd, onFocus }) => {
	...
	return (
		<div className="flex gap-2 h-8 min-w-0">
			<input
				className="grow min-w-0 bg-gray-300 dark:bg-gray-700 rounded-md px-2 focus:outline-none
				poppins text-base"
				type="text"
			...
			<select
				className="w-40 bg-gray-300 dark:bg-gray-700 rounded-md px-1 focus:outline-none
