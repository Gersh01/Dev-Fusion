      ...
      <div className="w-[400px] h-[520px] p-2.5 flex-col justify-start items-center gap-5 inline-flex">
        <div className="self-stretch grow shrink basis-0 flex-col justify-center items-center gap-[20px] flex">
          <div className="self-stretch h-[280px] flex-col justify-center items-center gap-4 flex">
            <div className="self-stretch text-center text-white text-4xl font-bold italic inter uppercase leading-10">
              Thrive in the power of open-source to drive innovation!
            </div>
            <div className="self-stretch text-center text-white text-md font-normal crimson-pro leading-tight">
              Whether you are a seasoned developer or just starting out, you
          ...
          <div className="self-stretch text-center text-white text-2xl font-semibold inter leading-tight">
            <ReactTyped
              strings={[
